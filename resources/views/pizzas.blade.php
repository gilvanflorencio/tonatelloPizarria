...
@foreach ($pizzas as $pizza)
   <tbody>
      ...
      <td><a href="/detalhe/{{$pizza->id}}"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrows-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg></a> <a href="/deletePizza/{{$pizza->id}}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
